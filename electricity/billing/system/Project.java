...
public class Project extends JFrame implements ActionListener{
   ...
   public void actionPerformed(ActionEvent ae){
       String mgs= ae.getActionCommand();
       if(mgs.equals("New Customer")){
           new NewCustomer();
       }else if(mgs.equals("Calculate Bill")){
                new CalculateBill();   
       }else if(mgs.equals("Deposit Details")){
           new DepositDetails();
       }else if(mgs.equals("Customer Details")){
           new CustomerDetails();
       }else if(mgs.equals(" View Information")){
           new  ViewInformation(meter);
       }else if(mgs.equals(" Update Information")){
           new  UpdateInformation(meter);
       }else if(mgs.equals(" Bill Details")){
           new  BillDetails(meter);
       }else if(mgs.equals("Notepade")){
           try{
              Runtime.getRuntime().exec("notepad.exe");
           }catch(Exception e){
               e.printStackTrace();
           }
       }else if(mgs.equals("Calculator")){
           try{
              Runtime.getRuntime().exec("calc.exe");
           }catch(Exception e){
               e.printStackTrace();
           }
       }else if(mgs.equals("Exit")){
           setVisible(false);
           new Login();
       }else if(mgs.equals("Pay Bill")){
           new PayBill(meter);
       }else if(mgs.equals("Generate Bill")){
